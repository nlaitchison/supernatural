package com.supernatural.entity
{
	...
	public class PlayerSprite extends FlxSprite
	{
		...
		public function PlayerSprite(playerType:String, X:Number=0, Y:Number=0, SimpleGraphic:Class=null)
		{
			super(X, Y);
			...
			if(playerType == "sam")
				loadGraphic(Resource.SAM_PLAYER, true, true, 18, 23);
		...
		public function get options():Boolean
		{
			return _options;
		}
		
		public function set options(value:Boolean):void
		{
			_options = value;
		}
		
		public function get endGame():Boolean
		{
			return _endGame;
		}
		
		public function set endGame(value:Boolean):void
		{
			_endGame = value;
		}
	}
